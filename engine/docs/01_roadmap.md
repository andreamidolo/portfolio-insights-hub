...
**Profili configurabili (4 linee) + design system ✅**
...
- [x] Design system `wealth` (burgundy/sand, Raleway) sulla dashboard: StatCard, tabelle editoriali, grafici recharts (donut/barre), tabella 41 modelli ordinabile. Vedi `docs/validation/risk_profiles_and_design_results.md`

**Produzione (dopo) — "benzina vera"**
- [ ] Backtest (equity line walk-forward + drawdown) — prossima iterazione front-end
- [ ] Editor front-end delle bande profili (import/export) + valori reali del cliente
